...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  OSL(5),         OSM(MOD_LCTL), OSM(MOD_LGUI), OSM(MOD_LALT), LOWER, KC_SPC, KC_SPC, RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT         \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
  _______, _______,    _______,    _______,    _______,    _______, _______, MO(5),   KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT  \
),
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, KC_LBRC, KC_UNDS, KC_PLUS, KC_RCBR, KC_PIPE, XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, \
  _______, KC_LCBR, KC_MINS, KC_EQL,  KC_RBRC, KC_BSLS, XXXXXXX, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, \
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, \
  _______, _______, _______, _______, MO(5),   _______, _______, _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT  \
),
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, QK_BOOT, DB_TOGG, _______, _______, CG_NORM, CG_SWAP, _______, _______, _______, _______, KC_DEL,  \
